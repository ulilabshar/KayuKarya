                                  ...
                                  Padding(
                                    ...
                                    child: StreamBuilder<
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<ProductCategoriesRecord>
                                            containerProductCategoriesRecordList =
                                            snapshot.data!;
                                        // Return an empty Container when the item does not exist.
                                        if (snapshot.data!.isEmpty) {
                                          return Container();
                                        }
                                        final containerProductCategoriesRecord =
                                            containerProductCategoriesRecordList
                                                    .isNotEmpty
                                                ? containerProductCategoriesRecordList
                                                    .first
                                                ...
                                                ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          8.0),
                                                  child: Image.network(
                                                    containerProductCategoriesRecord!
                                                        .image,
                                                    width: 70.0,
                                                    height: 70.0,
                                                    fit: BoxFit.cover,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.asset(
                                            'assets/images/sportswear-club-fleece-pullover-hoodie-Gw4Nwq.png',
                                            width: 70.0,
                                            height: 70.0,
                                            fit: BoxFit.cover,
                                          ),
